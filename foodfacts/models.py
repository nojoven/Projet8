...
class Products(models.Model):
    ...
    stores = models.CharField(db_column='Stores', max_length=500)  # Field name made lowercase.
    brands = models.CharField(db_column='Brands', max_length=500)  # Field name made lowercase.
    ...
    sugars_100g = models.FloatField(db_column='Sugars_100g')  # Field name made lowercase.
    saturated_fat_100g = models.FloatField(db_column='Saturated_Fat_100g')  # Field name made lowercase.
    energy_kcal_100g = models.FloatField(db_column='Energy_Kcal_100g')  # Field name made lowercase.
    ...
    proteins_100g = models.FloatField(db_column='Proteins_100g')  # Field name made lowercase.
    carbs_100g = models.FloatField(db_column='Carbs_100g')  # Field name made lowercase.
    sodium_100g = models.FloatField(db_column='Sodium_100g')  # Field name made lowercase.
